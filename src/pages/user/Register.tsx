    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="bg-white border-4 border-black shadow-[12px_12px_0_0_#000] rounded-[32px] w-full max-w-2xl p-8 md:p-10 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <button type="button" className="bg-white border-2 border-black px-6 py-3 rounded-2xl font-black text-xs shadow-[4px_4px_0_0_#000] active:translate-y-1 active:shadow-none transition-all flex items-center gap-3 cursor-pointer">
